							...
							<div class="card-body">
								<div class="p-4">
									...
									<div class="mb-3 text-center">
										<img src="<?php echo base_url('public/admin/assets/images/logo/logo.png') ?>" width="60" alt="" />
									</div>
									...
									<div class="form-body">
										<form class="row g-3" action="<?php echo base_url('Admin/authenticate') ?>" method="post">
											...
											<div class="col-md-6 text-end"> <a href="<?php echo base_url('Admin/forgot_password') ?>">Forgot Password ?</a>
											</div>
											<div class="col-12">
												<div class="d-grid">
