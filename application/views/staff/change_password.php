            ...
            <div class="container">
                <div class="row row-cols-1 row-cols-lg-2 row-cols-xl-3">
                    <div class="col mx-auto">
                        <div class="card">
                            <div class="card-body">
                                <form class="row g-3" action="<?php echo base_url('Staff/update_password') ?>" method="post">
                                    <input type="hidden" name="user_id" id="user_id" value="<?php echo $user_profile[0]['staff_id']; ?>">
