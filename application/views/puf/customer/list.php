            ...
            <div class="page-content">
                ...
                <div class="card">
                    <div class="card-header text-left">
                        <a href="<?php echo base_url('Customer/customer_create') ?>" class="btn btn-primary" style="float:right;">Add Customer</a>
                    </div>
                    <div class="card-body">
                                                ...
                                                <?php if (!empty($clist)) {
                                                    ...
                                                    foreach ($clist as $list) { ?>
                                                        ...
                                                        <tr role="row" class="odd">
                                                            ...
                                                            <td><?php echo $list['cmobile']  ?></td>
                                                            <td><?php echo $list['caddress']  ?></td>
                                                            <td>
                                                                <a type="button" href="<?php echo base_url('Customer/customer_edit/' . $list['id']); ?>" class="btn btn-outline-primary" data-placement="top" title="Edit"><i class="bx bx-edit me-0"></i></a>
                                                                <a type="button" href="<?php echo base_url('Customer/customer_delete/' . $list['id']); ?>" class="btn btn-outline-danger" data-placement="top" title="Delete"><i class="bx bx-trash me-0"></i></a>
                                                            </td>
                                                        </tr>
                                                <?php }
                                                } ?>
