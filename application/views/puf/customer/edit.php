        ...
        <div class="page-wrapper">
            <div class="page-content">
                ...
                <div class="card">
                    ...
                    <form action="<?php echo base_url('Customer/customer_update');  ?> " id="inventory_form" method="post" autocomplete="off">
                        <input type="hidden" name="update_id" id="update_id" value="<?php echo $cedit[0]['id'] ?>">
                        <div class="card-body">
                            <div class="col-md-12 row">

                                <div class="form-group col-md-3 p-2">
                                    <label for="role"> NAME<span style="color:red;font-weight:bolder">*</span></label>
                                    <input type="text" class="form-control" name="cname" id="cname" value="<?php echo $cedit[0]['cname'] ?>">
                                ...
                                <div class="form-group col-md-3 p-2">
                                    ...
                                    <input type="text" class="form-control" name="cemail" id="cemail" value="<?php echo $cedit[0]['cemail'] ?>">
                                ...
                                <div class="form-group col-md-3 p-2">
                                    ...
                                    <input type="text" class="form-control" name="cmobile" id="cmobile" value="<?php echo $cedit[0]['cmobile'] ?>">
                                ...
                                <div class="form-group col-md-3 p-2">
                                    ...
                                    <input type="text" class="form-control" name="gst_no" id="gst_no" value="<?php echo $cedit[0]['gst_no'] ?>">
                            ...
                            <div class="col-md-12 row">
                                <div class="form-group col-md-3 p-2">
                                    ...
                                    <textarea name="caddress" id="caddress" cols="5" rows="4" class="form-control"><?php echo $cedit[0]['caddress'] ?></textarea>
