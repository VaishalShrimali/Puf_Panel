    ...
    <div class="wrapper">
        ...
        <div class="page-wrapper">
            <div class="page-content">
                ...
                <h6 class="mb-0 text-uppercase">New Purchase</h6>
                <hr>
                <div class="card">
                        ...
                        <div class="card-body">
                            <div class="col-md-12 row">
                                ...
                                <div class="form-group col-md-3 p-2">
                                    <label for="role">VENDOR<span style="color:red;font-weight:bolder">*</span></label>
                                    <input type="text" class="form-control" name="vendor" id="vendor" value="">
                                    <div class=text-danger><?php echo form_error('vendor'); ?></div>
                                </div>

                                <div class="form-group col-md-3 p-2">
                                    <label for="role">ITEMS<span style="color:red;font-weight:bolder">*</span></label>
                                    <!--  <input type="text" class="form-control" name="name" id="name" value=""> -->
                                    <select name="items" id="items" class="form-select">
                                        <option selected="" disabled="">--Select--</option>
                                    </select>
                                    <div class=text-danger><?php echo form_error('items'); ?></div>
                                </div>
                            </div>
                        </div>
