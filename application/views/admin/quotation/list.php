        ...
        <div class="page-wrapper">
            <div class="page-content">
                ...
                <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
                    <div class="breadcrumb-title pe-3">Qutotation</div>
                    <div class="ps-3">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 p-0">
                                <li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
                                </li>
                                <li class="breadcrumb-item active" aria-current="page">Quotation Table</li>
                            </ol>
                        </nav>
                    </div>
                ...
                <h6 class="mb-0 text-uppercase">Quotation List</h6>
                <hr>
                <div class="card">
                                                ...
                                                <?php if (!empty($puf)) {
                                                    ...
                                                    foreach ($puf as $Pufs) { ?>
                                                        ...
                                                        <tr role="row" class="odd">
                                                            ...
                                                            <td><?php echo $Pufs['customer_name'] ?></td>
                                                            <!-- 
                                                            ...
                                                            <td><span class="badge <?php $Pufs['quotation_status'] == 'Approved' ? print('bg-success') : print('bg-danger');  ?>"><?php echo $Pufs['quotation_status']  ?></span></td>
                                                            <td>
                                                                <a type="button" href="<?php echo base_url('Puf/Qutoation') ?>" class="btn btn-outline-primary" data-toggle="tooltip" data-placement="top" title="Invoice"><i class="bx bx-edit me-0"></i></a>

                                                                <a type="button" href="<?php echo base_url('Quotation/approved/' . $Pufs['id']); ?>" class="btn btn-outline-info" data-placement="top" title="Edit"><i class="lni lni-certificate"></i>
                                                                </a>
                                                            </td>
                                                        </tr>
                                                <?php }
