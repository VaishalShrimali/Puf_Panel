        ...
        <div class="page-wrapper">
            <div class="page-content">
                ...
                <div class="card">
                    ...
                    <form action="<?php echo base_url('Role/update') ?>" id="roleform" method="post">
                        <input type="hidden" name="update_id" id="update_id" value="<?php echo $role[0]['role_id'] ?>">
                        <div class="card-body">
                            <div class="col-md-12 row">

                                <div class="form-group col-md-6">
                                    <label for="role">Role <span style="color:red;font-weight:bolder">*</span></label>
                                    <input type="text" class="form-control" name="role" id="role" value="<?php echo $role[0]['role']; ?>">
                                </div>
                            </div>
                        </div>
