            ...
            <div class="page-content">
                ...
                <div class="card">
                    <div class="card-header text-left">
                        <a href="<?php echo base_url('Role/create') ?>" class="btn btn-primary" style="float:right;">Add Role</a>
                    </div>
                    <div class="card-body">
                                                ...
                                                <?php if (!empty($roles)) {
                                                    ...
                                                    foreach ($roles as $role) { ?>
                                                        ...
                                                        <tr role="row" class="odd">
                                                            ...
                                                            <td>
                                                                <a type="button" href="<?php echo base_url('Role/edit/' . $role['role_id']) ?>" class="btn btn-outline-primary"><i class="bx bx-edit me-0"></i>
                                                                </a>
                                                                <a type="button" href="<?php echo base_url('Role/delete/' . $role['role_id']) ?>" class="btn btn-outline-danger" onclick="return confirm('Do you want delete this record?')"><i class="bx bx-trash me-0"></i>
                                                                </a>
                                                            </td>
