        ...
        <div class="page-wrapper">
            <div class="page-content">
                ...
                <div class="card">
                    ...
                    <form action="<?php echo base_url('Role/staff_insert') ?>" id="staff_form" method="post" autocomplete="off">
                        <div class="card-body">
                            <div class="col-md-12 row">
                                ...
                                <div class="form-group col-md-6  p-2">
                                    ...
                                    <br>
                                    <input class="form-control" type="text" name="phone" id="phone" value="" onkeypress="return event.charCode >= 48 && event.charCode <= 57" minlength="11" maxlength="10">
