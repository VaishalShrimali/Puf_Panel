    ...
    <div class="wrapper">
        ...
        <div class="page-wrapper">
            <div class="page-content">
                    ...
                    <div class="ps-3">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb mb-0 p-0">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">List Inventory</li>
                            </ol>
                        </nav>
                    </div>
                ...
                <h6 class="mb-0 text-uppercase">List inventory</h6>
                <hr>
                <div class="card">
                    <div class="card-header text-left">
                        <a href="<?php echo base_url('Inventory/create') ?>" class="btn btn-primary" style="float:right;">Add Inventory</a>
                    </div>
                    <div class="card-body">
                                            ...
                                            <tbody>
                                                <?php if ($inventory != '') {
                                                    ...
                                                    foreach ($inventory as $val) { ?>
                                                        ...
                                                        <tr>
                                                            <td><?= $id; ?></td>
                                                            <td><?= $val['raw_matrial']; ?></td>
                                                            <td><?= $val['quantity']; ?></td>
                                                            <td>
                                                                <a type="button" href="<?php echo base_url('Inventory/edit/' . $val['inventory_id']) ?>" class="btn btn-outline-primary"><i class="bx bx-edit me-0"></i>
                                                                </a>
                                                                <a type="button" href="<?php echo base_url('Inventory/delete/' . $val['inventory_id']) ?>" class="btn btn-outline-danger" onclick="return confirm('Do you want delete this record?')"><i class="bx bx-trash me-0"></i>
                                                                </a>
                                                            </td>
